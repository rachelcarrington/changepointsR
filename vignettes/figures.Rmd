...
Figure 2(a): simulating under $H_0$ not including original. Here we have used 100 simulations so that the code is quicker to run; to reproduce the plot in the paper change num_iter to 1000. To reproduce Figure 2(b) set h = 20.
